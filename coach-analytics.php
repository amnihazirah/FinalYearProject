<?php
	...
	$result_combine=mysqli_query($conn,"SELECT off_userID, off_activity, time_start, time_end, date from off_field UNION ALL SELECT on_userID as off_userID, on_activity as off_activity,time_start, time_end, date from on_field GROUP BY off_userID ORDER BY date");
